...
exports.getDateDetails = employmentDate => {
...
exports.formatDateToString = inputDate => {
...
exports.convertDateFormat = inputDate => {
  const date = moment(inputDate, "MM/DD/YYYY h:mm:ss A");
  const formattedDate = date.format("YYYY-MM-DD");
  return formattedDate;
};

exports.convertDateFormatMonthFirst = inputDate => {
  const date = moment(inputDate);
